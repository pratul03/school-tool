      ...
      <Tabs defaultValue="single" className="w-full">
        <div className="px-5 pt-6">
          <TabsList className="relative grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 h-14 rounded-lg bg-gray-100 p-1">
            <TabsTrigger
              value="single"
              className="relative z-10 flex items-center justify-center gap-2 w-full h-full  text-base font-semibold tracking-tight transition-colors rounded-md px-4 py-2"
            >
